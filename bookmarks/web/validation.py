...
class BookmarkCreateSchema(BaseModel):
    ...
    tags: List[str] = Field(default_factory=list, description="Comma-separated tags or list of tags")
...
class BookmarkUpdateSchema(BaseModel):
    ...
    title: Optional[str] = Field(None, min_length=1, max_length=500, description="The title of the bookmark")
    description: Optional[str] = Field(None, max_length=2000, description="The description of the bookmark")
    tags: Optional[List[str]] = Field(None, description="Comma-separated tags or list of tags")
