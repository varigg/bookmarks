...
BACKUP_ENABLED: bool = get_config("BOOKMARKS_BACKUP_ENABLED", "true").lower() in ("true", "1", "yes")
...
# LLM configuration
LLM_PROVIDER: str = get_config("BOOKMARKS_LLM_PROVIDER", "perplexity")  # perplexity, perplexity-mcp, openai, anthropic
